...
class _OfflineVideosState extends State<OfflineVideos> {
  ...
  @override
  void initState() {
    excerciseDescriptionFormatted = formatDescription(widget.excerciseDescription);
    super.initState();
  }
            ...
            children: [
              Center(
                child: Padding(
                  ...
                  child: VideoPlayerWidget(videoUrl: widget.mainVideoURL, videoPath: widget.videoPath),
                ),
              ),
              Padding(
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: widget.relatedVideosList?.length ??
                      0, 
